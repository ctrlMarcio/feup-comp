...
public class Calculator/*@bgen(jjtree)*/implements CalculatorTreeConstants, CalculatorConstants {/*@bgen(jjtree)*/
  protected static JJTCalculatorState jjtree = new JJTCalculatorState();public static void main(String[] args) throws ParseException {
        ...
        try {
            SimpleNode root = Calculator.Expression(); // returns reference to root node
  ...
  static final public void AssignCalc() throws ParseException {
                                /*@bgen(jjtree) AssignCalc */
  SimpleNode jjtn000 = new SimpleNode(JJTASSIGNCALC);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);
    try {
      if (jj_2_1(2)) {
  ...
  static final public void Assign() throws ParseException {
                        ...
                        boolean jjtc000 = true;
                        jjtree.openNodeScope(jjtn000);Token var, number; int sign = 1;
    try {
      var = jj_consume_token(SYMBOL);
      ...
      number = jj_consume_token(INTEGER);
                                                                    CalculatorMemory.add(var.image, sign * Integer.parseInt(number.image));
  ...
  static final public void Account() throws ParseException {
                 /*@bgen(jjtree) Account */
  SimpleNode jjtn000 = new SimpleNode(JJTACCOUNT);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);
    try {
      Expr1(1);
  ...
  static final public void Expr3(int sign) throws ParseException {
    ...
    if (jj_2_11(2)) {
      ...
      try {
                     ...
                     jjtc002 = false;
                    jjtn002.val = sign * CalculatorMemory.get(t.image);
      } finally {
                     if (jjtc002) {
                       jjtree.closeNodeScope(jjtn002, true);
                     }
